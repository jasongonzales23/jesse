...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('gallery_gallery', 'description', self.gf('django.db.models.fields.TextField')(default=0, max_length=10000), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Gallery.description'
        db.delete_column('gallery_gallery', 'description')
