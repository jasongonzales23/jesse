...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'GalleryPlugin.page'
        db.delete_column('cmsplugin_galleryplugin', 'page')


    def backwards(self, orm):
        
        # Adding field 'GalleryPlugin.page'
        db.add_column('cmsplugin_galleryplugin', 'page', self.gf('django.db.models.fields.CharField')(default=0, max_length=255), keep_default=False)
